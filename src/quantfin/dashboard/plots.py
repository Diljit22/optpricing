...
def plot_iv_surface_3d(market_surface: pd.DataFrame, model_surfaces: Dict[str, pd.DataFrame], ticker: str):
    ...
    fig.update_layout(title=f'Implied Volatility Surface for {ticker}', scene=dict(xaxis_title='Maturity (Years)', yaxis_title='Strike', zaxis_title='Implied Volatility'), margin=dict(l=0, r=0, b=0, t=40))
    return fig

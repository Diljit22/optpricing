...
def profile_all_metrics(technique: Any, option: Option, stock: Stock, model: BaseModel, rate: Rate, **kwargs):
    ...
    try:
        if np.isfinite(price_val):
            iv_val = technique.implied_volatility(option, stock, model, rate, target_price=price_val, **kwargs)
        else:
            iv_val = np.nan
...
if __name__ == "__main__":
    ...
    benchmark_configs = [
        ...
        },
        {
            ...
            "model_instance": MertonJumpModel(params={'sigma': 0.2, 'lambda': 0.5, 'mu_j': -0.1, 'sigma_j': 0.15, 'max_sum_terms': 100}),
            "stock": stock, "rate": rate,
            "techniques": {
        ...
        },
        {
            ...
            "model_instance": HestonModel(params={'v0': 0.04, 'kappa': 2.0, 'theta': 0.04, 'rho': -0.7, 'vol_of_vol': 0.5}),
            "stock": stock, "rate": rate, "kwargs": {'v0': 0.04},
            "techniques": {
                "Integration": IntegrationTechnique(),
                "FFT": FFTTechnique(),
                "MC": MonteCarloTechnique(n_paths=50000, n_steps=100, seed=42),
        ...
        },
        {
            ...
            "model_instance": BatesModel(params={'v0': 0.04, 'kappa': 2.0, 'theta': 0.04, 'rho': -0.7, 'vol_of_vol': 0.5, 'lambda': 0.5, 'mu_j': -0.1, 'sigma_j': 0.15}),
            "stock": stock, "rate": rate, "kwargs": {'v0': 0.04},
            "techniques": {
                "Integration": IntegrationTechnique(),
                "FFT": FFTTechnique(),
        ...
        },
        {
            ...
            "model_instance": VarianceGammaModel(params={'sigma': 0.2, 'nu': 0.1, 'theta': -0.14}),
            "stock": stock, "rate": rate,
            "techniques": {
                "Integration": IntegrationTechnique(),
                "FFT": FFTTechnique(),
        ...
        },
        {
            ...
            "model_instance": KouModel(params={'sigma': 0.15, 'lambda': 1.0, 'p_up': 0.6, 'eta1': 10.0, 'eta2': 5.0}),
            "stock": stock, "rate": rate,
            "techniques": {
                "Integration": IntegrationTechnique(),
                "FFT": FFTTechnique(),
        ...
        },
        {
            ...
            "model_instance": CGMYModel(params={'C': 0.02, 'G': 5.0, 'M': 5.0, 'Y': 1.2}),
            "stock": stock, "rate": rate,
            "techniques": {
                "Integration": IntegrationTechnique(),
                "FFT": FFTTechnique(),
        ...
        },
        {
            ...
            "model_instance": NIGModel(params={'alpha': 15.0, 'beta': -5.0, 'delta': 0.5}),
            "stock": stock, "rate": rate,
            "techniques": {
                "Integration": IntegrationTechnique(),
                "FFT": FFTTechnique(),
        ...
        },
        {
            ...
            "model_instance": HyperbolicModel(params={'alpha': 15.0, 'beta': -5.0, 'delta': 0.5, 'mu': 0.0}),
            "stock": stock, "rate": rate,
            "techniques": {
                "Integration": IntegrationTechnique(),
                "FFT": FFTTechnique(),
        ...
        },
        {
            ...
            "model_instance": SABRModel(params={'alpha': 0.5, 'beta': 0.8, 'rho': -0.6}),
            "stock": stock, "rate": rate, "kwargs": {'v0': 0.5},
            "techniques": {
                "MC": MonteCarloTechnique(n_paths=50000, n_steps=100, seed=42),
            }
        },
        {
            ...
            "model_instance": SABRJumpModel(params={'alpha': 0.5, 'beta': 0.8, 'rho': -0.6, 'lambda': 0.4, 'mu_j': -0.1, 'sigma_j': 0.15}),
            "stock": stock, "rate": rate, "kwargs": {'v0': 0.5},
            "techniques": {
                "MC": MonteCarloTechnique(n_paths=50000, n_steps=100, seed=42),
            }
